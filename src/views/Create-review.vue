...
<template>
  ...
  >
        ...
        <div class="modal-content">
          <div class="modal-text-container">
            <p class="modal-message">
              Merci pour votre partage . Votre annonce sera verifiée dans les
              plus bref delai, et sera consultable pendant 90 jours aprés
              publication
            </p>
          </div>
          ...
          <div class="container-gallery">
            <div class="container-top-pictures">
              <div class="container-picture2 pictures-container">
                ...
                <button class="button-gallery" @click="triggerFileInputSecond">
                  ajouter une photo
                </button>
              ...
              <div class="container-picture3 pictures-container">
                ...
                <button class="button-gallery" @click="triggerFileInputThird">
                  ajouter une photo
                </button>
            ...
            <div class="container-bottom-pictures">
              <div class="container-picture4 pictures-container">
                ...
                <button class="button-gallery" @click="triggerFileInputFourth">
                  ajouter une photo
                </button>
              ...
              <div class="container-picture5 pictures-container">
                ...
                <button class="button-gallery" @click="triggerFileInputFifth">
                  ajouter une photo
                </button>
    ...
    <div v-if="!isDesktop" class="container-mobile-picture">
      <div
    ...
    <div v-if="isDesktop" class="container-button-submit">
      <div v-show="!isUserConnected" class="modal-expired-container">
    ...
    <div v-if="!isDesktop" class="container-mobile-button-submit">
      <div v-show="!isUserConnected" class="modal-expired-container">
        <div class="modal-expired-message">
          votre session a éxpirer, pour enregistrer votre review veuillez vous
          connecter a nouveau
      ...
      <button
        ...
        @click="
          (submitMobileForm($event), logFormData(), handleErrorsBeforeSubmit())
        "
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      if (
        this.formData.mobilePictures &&
        this.formData.mobilePictures.length > 0
      ) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log(
            'Pictures not shared to API, try again.  !!!!!!!',
            errorData,
            'with response : ',
            response,
            'valid from submitform() response :',
            (this.isUserConnected = errorData.valid)
          );
