            ...
            <div :class="{ 'fields-container': isDesktop }">
                ...
                <div :class="{ 'left-part-form': isDesktop }">
                    ...
                    <div :class="{ 'container-left-part-form': isDesktop }">
                        ...
                        <input class="signup-input email-input" type="text" v-model="email" required
                            placeholder="email" />

                        <input class="signup-input checkVerifyEmail-input" type="text" v-model="checkVerifyEmail"
                            required placeholder="verification email" />

                        <input class="signup-input password-input" type="password" v-model="password" required
                            placeholder="mot de passe" />

                        <input class="signup-input password-input" type="password" v-model="passwordConfirmation"
                            required placeholder="confirmation du mdp" />
                        ...
                        <input class="signup-input city-input" type="text" v-model="city" required
                            placeholder="Ville" />
                ...
                <div :class="{ 'right-part-form': isDesktop }">
                    ...
                    <div :class="{ 'container-right-part-form': isDesktop }">
                        ...
                        <div class="captcha-container" :class="{ 'desktop-captcha-container': isDesktop }">
                            <recaptchaComponent class="recaptcha-component"
