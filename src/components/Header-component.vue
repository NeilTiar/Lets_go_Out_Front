<template>
  <div
    ...
    :class="{
      'desktop-style': isDesktop,
      'mobile-style': !isDesktop,
  ...
  >
    <div class="header">
      <div class="container-logo-title">
        <div class="container-title">
          ...
          <h2 v-if="isDesktop" class="title-description">
    ...
    <div v-if="isDesktop" class="container-user-dark-theme">
      <div
      ...
      >
        ...
        <div
          :class="{
            'msg-user-log': !isDarkMode,
            'dark-mode-user-logo': isDarkMode,
          }"
        >
          Bonjour, {{ pseudo }}
        </div>
        ...
        >
          <ul>
            ...
            <li class="user-menu-list" @click="redirectToFavorites()">
              mes coup de coeur
            </li>
            <li class="user-menu-list">besoin d'aide ? Chat Room</li>
            <li class="user-menu-list" @click="signOut()">Déconnexion</li>
          </ul>
        </div>
    ...
    <div
      ...
      :class="{
        'container-user-connexion-mobile': !isDesktop,
        'container-user-connexion-desktop': isDesktop,
        'dark-container-user-connexion': !isDesktop && isDarkMode,
      }"
    ...
    >
      <div
        v-if="
          $route.path === '/review-details' || $route.path === '/create-review'
        "
        class="return-button"
    ...
    <div v-if="isDesktop" class="top-desktop-menu">
      <nav v-if="!$route.path.includes('admin')" class="theme-banner">
        <ul class="themes" @mouseover="startHover" @mouseout="endHover">
          <li class="theme-link">
            <a class="theme-link culture-link" href="#Culture">Culture</a>
          </li>
          <li class="theme-link">
            <a class="theme-link food-and-drink-link" href="#FoodAndDrink"
              >Food & Drink</a
            >
          </li>
          <li class="theme-link">
            <a class="theme-link loisir-link" href="#Loisir">Loisirs</a>
          </li>
        </ul>

        <div class="container-create-review-link">
          <li v-if="pseudo != `visitor`" class="link-create-review">
            <a class="create-link" @click="navigateToCreateReview"
              >Creer une review
            </a>
        ...
        <div v-if="isAdmin && isDesktop" class="admin-button-link">
    ...
    <div
      ...
      class="top-menu"
      :class="[
        { 'fixed-container': isFixed, 'dark-top-menu': isDarkMode },
        'top-main',
      ]"
    >
...
export default {
  ...
  methods: {
    ...
    handleReturnButton() {
      ...
      console.log(
        'XXXXXX test XxxXXXXXXXXXxxxXXXXX =========>',
        store.state.currentReviewsPage
      );
    },
